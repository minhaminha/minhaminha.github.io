...
, function(t, e, n) {
    ...
    const xt = [[null, [[wt / 6, 0], ["bio"]], null], [[[0, 0], ["welcome"]], [[0, 0], ["crossroad"]], [[-wt / 6, -mt / 6], [wt / 6, 0], [0, mt / 6], ["bounchie", "portfolio", "notice"]]], [null, [[-wt / 6, 0], ["links"]], null]]
      , bt = ["Welcome to my interactive portfolio :)", "Navigate UP to learn more!"]
      ...
      , At = ["I am a software engineer with 4 years of experience", "in full stack development, database management", "and UI/UX design. Having worn many hats", "previously developing for and maintaining a SaaS", "platform, I am continually motivated by new", "challenges that allow for growth and learning. I am", "interested in roles and projects that directly impact", "the end users’ productivity.", "I currently live in NYC with my cat, Bimmy."]
      , Et = ["I am a software engineer with 4 years of experience in full stack development,", "database management and UI/UX design. Having worn many hats previously", "developing for and maintaining a SaaS platform, I am continually motivated by", "new challenges that allow for growth and learning. I am interested in roles and", "projects that directly impact the end users’ productivity.", "I currently live in NYC with my cat, Bimmy.", " "]
      , kt = ["Skills!", "- Python", "- JS", "- Java", "- HTML/CSS", "- SQL"]
      , Tt = ["Interests!", "- Web Design", "- Game/App Dev", "- Continous Learning"]
      , Ot = ["Buzzwords!", "- Fast-learner", "- Creative", "- Curious", "- Team Player"]
